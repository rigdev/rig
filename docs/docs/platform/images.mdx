...
To add a new image, simply insert the container image and click "Add image". The platform will validate the image against the Container Registry, defaulting to `index.docker.io` if omitted.
