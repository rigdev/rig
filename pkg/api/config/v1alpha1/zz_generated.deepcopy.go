...
func (in *Extensions) DeepCopyInto(out *Extensions) {
	*out = *in
	if in.Values != nil {
		...
		*out = make([]ValueExtension, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValueExtension) DeepCopyInto(out *ValueExtension) {
	*out = *in
	in.Schema.DeepCopyInto(&out.Schema)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValueExtension.
func (in *ValueExtension) DeepCopy() *ValueExtension {
	if in == nil {
		return nil
	}
	out := new(ValueExtension)
	in.DeepCopyInto(out)
	return out
}
