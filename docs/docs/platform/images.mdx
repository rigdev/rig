...
To deploy an image simply add a new image, or select a previsouly deployed one, and click `Deploy Now`. This will initiate a new [Rollout](rollouts), upgrading the instances to this image.
