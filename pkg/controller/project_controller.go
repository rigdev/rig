...
func (p *ProjectEnvironmentController) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if _, err := pipeline.ExecuteRequest(ctx, request, projectSteps, true, pipeline.Options{}); err != nil {
...
func (s namespaceStep) Apply(_ context.Context, req pipeline.ProjectEnvironmentRequest, _ pipeline.Options) error {
