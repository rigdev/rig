...
// Mod is the interface a rig plugin must implement to be used by the rig-operator
type Mod interface {
...
// InitializeRequest contains information needed to initialize the mod
...
// StartMod starts the plugin so it can listen for requests to be run on a CapsuleRequest
// name is the name of the plugin as referenced in the rig-operator configuration.
func StartMod(name string, rigMod Mod) {
