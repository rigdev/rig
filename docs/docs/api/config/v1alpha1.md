...
| Field | Description |
| --- | --- |
| `id` _string_ | Optional name which is readable by plugin when executed |
| `name` _string_ | The plugin type to run. |
...
| Field | Description |
| --- | --- |
| `id` _string_ | Optional name which is readable by plugins when executed |
