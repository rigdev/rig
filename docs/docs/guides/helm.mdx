...
[onboarding](/operator-manual/onboarding) section.

:::info Prerequisites
To follow along with this guide, you need to have following:
- [rig CLI Installed](/getting-started/cli-install)
- [rig-ops CLI installed](/operator-manual/cli)
- Rig Platform and Operator Running either in [KIND](/getting-started/platform-installation) or in a [real K8s environment](/operator-manual/setup-guide)
:::
...
To migrate the Helm Chart to a Capsule, we will use the [migrate](/operator-manual/onboarding) command 
...
This will go through the flow described in the [onboarding guide](/operator-manual/onboarding), and at the end
