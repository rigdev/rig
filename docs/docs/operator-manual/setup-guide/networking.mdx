...
If our builtin plugin for handling routes doesn't fit your needs, you can write your own third-party plugin supplying a different behaviour. We will shortly have documentation on how to write custom plugins.
