...
If the Source Of Truth is a Git repository, any committed change to the capsule's file will result in a [Rollout](/platform/rollouts) and subsequent Kubernetes resource creation/update. Likewise, any rollout to a Git backed capsule will first result in Git commit.
...
rig:
  client:
    git:
      ...
      gitLabAuths
        # Matches git@gitlab.com:mygroup/subgroup1/subgroup2/myproject.git and enables WebHook
        - groups:
            - mygroup
            - subgroup1
            - subgroup2
