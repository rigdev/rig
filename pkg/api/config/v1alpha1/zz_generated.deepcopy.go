...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JSONObjectSchema) DeepCopyInto(out *JSONObjectSchema) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JSONObjectSchema.
func (in *JSONObjectSchema) DeepCopy() *JSONObjectSchema {
	if in == nil {
		return nil
	}
	out := new(JSONObjectSchema)
	in.DeepCopyInto(out)
	return out
}
