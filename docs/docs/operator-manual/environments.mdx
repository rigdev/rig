...
The Rig Platform supports a multi-environment architecture out-of-box.
...
a convening way of sharing node resources across environments and simplifying the overall
infrastructure.
