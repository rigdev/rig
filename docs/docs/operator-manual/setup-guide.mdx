...
:::info Note
Dashboard metrics require the Metric-Server in the kubernetes cluster.
See here for instructions on how to install it, if missing: https://github.com/kubernetes-sigs/metrics-server
:::
