...
| `envFromSource` _EnvReference array_ | A list of either ConfigMaps or Secrets which will be mounted in as environment variables to the container.<br />It's a reuse of the Capsule CRD |
...
| `files` _File array_ | Files is a list of files to mount in the container. These can either be<br />based on ConfigMaps or Secrets.<br />It's a reuse of the Capsule CRD |
